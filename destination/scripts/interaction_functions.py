...
#import text & speech functions
#sys.path.append(os.path.abspath("/home/jenny/jlam0014_ws/src/interactions/src/functions"))
#from main import * 
...
class VADAudio(Audio):
    ...
    def __init__(self, aggressiveness=3, device=None, input_rate=None, file=None):
        super(VADAudio,self).__init__(device=device, input_rate=input_rate, file=file)
        self.vad = webrtcvad.Vad(aggressiveness)

    def frame_generator(VADAudio,self):
    ...
    def vad_collector(self, padding_ms=300, ratio=0.75, frames=None):
        """Generator that yields series of consecutive audio frames comprising each utterence, separated by yielding a single None.
            ...
            Example: (frame, ..., frame, None, frame, ..., frame, None, ...)
                      |---utterence---|        |---utterence---|
        """
        if frames is None: frames = self.frame_generator(self)
